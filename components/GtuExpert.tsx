...
export const GtuExpert: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const splitMarker = result.includes("VISUAL_PROMPT:") ? "VISUAL_PROMPT:" : "INFOGRAPHIC DIAGRAM PROMPT";
            ...
            if (parts.length > 1 && parts[1].trim()) {
                ...
                // If no visual prompt was generated (rare), stop loading
                 setIsImageLoading(false);
            }
                        ...
                        <div className="space-y-8">
                            ...
                            {isImageLoading && (
                                <div className="border-2 border-dashed border-emerald-500/30 rounded-2xl p-8 flex flex-col items-center justify-center bg-black/20 text-emerald-200">
                                    ...
                                    <p className="font-bold animate-pulse">Designing Visual Aid (Graph/Chart/Model)...</p>
                                </div>
                            )}

                            {imageUrl && (
                                <div className="mt-8">
                                    <h4 className="text-lg font-bold text-emerald-300 mb-4 uppercase tracking-wider">
                                        Visual Explanation <span className="text-xs normal-case text-emerald-100/50 font-medium ml-2">(Click to zoom)</span>
                                    </h4>
                                    ...
                                    <p className="text-xs text-center text-indigo-400 mt-2">Generated by Gemini 2.5 Flash Image</p>
                                </div>
                            )}
